...
DEFAULT_COMMAND_MESSAGES: dict[str, dict[str, dict[str, str]]] = {
    ...
    "timeout": {
        "en": {
            ...
            "missing_member": "Choose a member first.",
            "missing_duration": "Enter a duration such as 10m, 2h, 1d, or 1w.",
            "invalid_member": "Choose a valid member.",
            "invalid_duration": "Use a valid duration such as 10m, 2h, 1d, or 1w (maximum 28 days).",
            "no_reason": "No reason provided.",
        },
        "ar": {
            ...
            "missing_member": "اختر عضواً أولاً.",
            "missing_duration": "اكتب مدة مثل 10m أو 2h أو 1d أو 1w.",
            "invalid_member": "اختر عضواً صحيحاً.",
            "invalid_duration": "استخدم مدة صحيحة مثل 10m أو 2h أو 1d أو 1w (بحد أقصى 28 يوماً).",
            "no_reason": "لم يتم تقديم سبب.",
        },
    },
    "untimeout": {
        "en": {
            "success": "Removed the timeout from {member}.\n\n> Reason: {reason}",
            "permission": "You need the Moderate Members permission to remove timeouts.",
            "dashboard_permission": "BirdBot needs the Moderate Members permission to remove timeouts.",
            "missing_member": "Choose a member first.",
            "not_timed_out": "{member} does not have an active timeout.",
            "no_reason": "No reason provided.",
        },
        "ar": {
            "success": "تمت إزالة الإسكات المؤقت عن {member}.\n\n> السبب: {reason}",
            "permission": "تحتاج إلى صلاحية إدارة الأعضاء لإزالة الإسكات المؤقت.",
            "dashboard_permission": "يحتاج BirdBot إلى صلاحية إدارة الأعضاء لإزالة الإسكات المؤقت.",
            "missing_member": "اختر عضوًا أولاً.",
            "not_timed_out": "لا يوجد إسكات مؤقت نشط على {member}.",
            "no_reason": "لم يتم تقديم سبب.",
        },
    },
    "mute": {
        "en": {
            "success": "Chat-muted {member} in this channel.",
            "permission": "You need the Manage Channels permission to use mute.",
            "dashboard_permission": "BirdBot needs the Manage Channels permission to manage chat mutes.",
            "missing_member": "Choose a member first.",
            "invalid_channel": "This command can only be used in a text channel.",
            "no_reason": "No reason provided.",
        },
        "ar": {
            "success": "تم منع {member} من الكتابة في هذه القناة.",
            "permission": "تحتاج إلى صلاحية إدارة القنوات لاستخدام هذا الأمر.",
            "dashboard_permission": "يحتاج BirdBot إلى صلاحية إدارة القنوات لإدارة كتم الدردشة.",
            "missing_member": "اختر عضواً أولاً.",
    ...
    "unmute": {
        "en": {
            "success": "Removed the chat mute from {member} in this channel.",
            "permission": "You need the Manage Channels permission to remove a chat mute.",
            "dashboard_permission": "BirdBot needs the Manage Channels permission to remove chat mutes.",
            "missing_member": "Choose a member first.",
            "invalid_channel": "This command can only be used in a text channel.",
            "not_muted": "{member} is not chat-muted in this channel.",
            "no_reason": "No reason provided.",
        },
        "ar": {
            "success": "تمت إزالة كتم الدردشة عن {member} في هذه القناة.",
            "permission": "تحتاج إلى صلاحية إدارة القنوات لإزالة كتم الدردشة.",
            "dashboard_permission": "يحتاج BirdBot إلى صلاحية إدارة القنوات لإزالة كتم الدردشة.",
            "missing_member": "اختر عضوًا أولاً.",
            "invalid_channel": "يمكن استخدام هذا الأمر في قناة نصية فقط.",
            "not_muted": "{member} غير مكتوم للدردشة في هذه القناة.",
            "no_reason": "لم يتم تقديم سبب.",
        },
    },
    "lock": {
