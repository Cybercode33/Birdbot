...
DEFAULT_COMMAND_MESSAGES: dict[str, dict[str, dict[str, str]]] = {
    ...
    "unmute": {
        "en": {
            "success": "Removed the server mute from {member}.",
            "permission": "You need the Mute Members permission to remove a server mute.",
            "dashboard_permission": "BirdBot needs the Mute Members permission to remove server mutes.",
            "missing_member": "Choose a member first.",
            "not_in_voice": "That member must be in a voice channel.",
            "not_muted": "{member} is not server-muted.",
            "no_reason": "No reason provided.",
        },
        "ar": {
            "success": "تمت إزالة كتم الصوت عن {member}.",
            "permission": "تحتاج إلى صلاحية كتم الأعضاء لإزالة كتم الصوت.",
            "dashboard_permission": "يحتاج BirdBot إلى صلاحية كتم الأعضاء لإزالة كتم الصوت.",
            "missing_member": "اختر عضوًا أولاً.",
            "not_in_voice": "يجب أن يكون العضو في قناة صوتية.",
            "not_muted": "{member} ليس مكتومًا من الخادم.",
            "no_reason": "لم يتم تقديم سبب.",
        },
    },
    "lock": {
